...
def handle_input(youtube_url, uploaded_file, video_audio_file):
...
with gr.Blocks() as demo:
    gr.Markdown("# 🎙️ AI Summarizer + Q&A + Audio (YouTube, Files, Audio, Video)")
    ...
    submit_btn.click(fn=handle_input,
                     inputs=[youtube_input, uploaded_file, video_audio_file],
